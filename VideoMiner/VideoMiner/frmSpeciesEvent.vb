...
#End Region
    ...
    Private Sub buildDictionary()
        ...
        ' the data value to be inserted, and a boolean for whether or not the item was the one pressed (in case there are more than one in the dictionary).
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, DoubleQuote(SpeciesName), True)
        m_dict.Add("SpeciesName", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, DoubleQuote(SpeciesCode), False)
        m_dict.Add("SpeciesID", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, Count, False)
        m_dict.Add("SpeciesCount", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, Side, False)
        m_dict.Add("Side", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, Range, False)
        m_dict.Add("Range", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, SpeciesLength, False)
        m_dict.Add("Length", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, SpeciesHeight, False)
        m_dict.Add("Height", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, SpeciesWidth, False)
        m_dict.Add("Width", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, Abundance, False)
        m_dict.Add("Abundance", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, IDConfidence, False)
        m_dict.Add("IDConfidence", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, DoubleQuote(Comments), False)
        m_dict.Add("Comment", m_tuple)
        m_tuple = New Tuple(Of String, String, Boolean)(SPECIES_EVENT, DoubleQuote(SPECIES_EVENT), False)
        m_dict.Add(DATA_CODE, m_tuple)
    End Sub
